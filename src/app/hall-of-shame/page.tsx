...
const HALL_OF_SHAME: CompanyScore[] = [
  ...
  },
  {
    ...
    score: 18,
    flags: [
      { flag: 'DATA_SHARING_EXTENSIVE', label: 'Extensive Data Collection', severity: 'high' },
      { flag: 'BROAD_INDEMNIFICATION', label: 'Broad Indemnification', severity: 'high' },
      { flag: 'CLASS_ACTION_WAIVER', label: 'Class Action Waiver', severity: 'high' },
      { flag: 'FOREIGN_JURISDICTION', label: 'Foreign Jurisdiction', severity: 'high' },
    ],
    worstClause: "TikTok collects biometric data, browsing history, and shares with affiliates. Disputes resolved in Singapore courts.",
  ...
  },
  {
    ...
    flags: [
      ...
      { flag: 'CLASS_ACTION_WAIVER', label: 'Class Action Waiver', severity: 'high' },
      { flag: 'PRICE_NOT_GUARANTEED', label: 'Price Not Guaranteed', severity: 'medium' },
      { flag: 'NON_REFUNDABLE', label: 'Limited Refunds', severity: 'medium' },
    ],
    worstClause: "Prices may differ from in-store prices. Service fees are non-refundable even if order is cancelled.",
    tosUrl: 'https://www.instacart.com/terms',
  ...
  },
  {
    ...
    flags: [
      { flag: 'BINDING_ARBITRATION', label: 'Binding Arbitration', severity: 'high' },
      { flag: 'CLASS_ACTION_WAIVER', label: 'Class Action Waiver', severity: 'high' },
      { flag: 'PRICE_NOT_GUARANTEED', label: 'Dynamic Pricing', severity: 'medium' },
    ],
    worstClause: "Lyft uses dynamic pricing with no cap. Your fare may be significantly higher than quoted during high demand.",
    tosUrl: 'https://www.lyft.com/terms',
  ...
  },
  {
    ...
    flags: [
      { flag: 'BINDING_ARBITRATION', label: 'Binding Arbitration', severity: 'high' },
      { flag: 'AUTO_RENEWAL_HIDDEN', label: 'Early Termination Fee', severity: 'high' },
      { flag: 'NON_REFUNDABLE', label: 'Non-Refundable', severity: 'high' },
    ],
    worstClause: "Cancelling annual subscription early incurs 50% of remaining contract as termination fee.",
    tosUrl: 'https://www.adobe.com/legal/terms.html',
  ...
  },
  {
    ...
    worstClause: "Disney+ automatically renews and requires arbitration for all disputes including billing issues.",
    tosUrl: 'https://www.disneyplus.com/legal/subscriber-agreement',
  ...
  },
  {
    ...
    flags: [
      { flag: 'DATA_SHARING_EXTENSIVE', label: 'Data Sharing', severity: 'medium' },
      { flag: 'BROAD_INDEMNIFICATION', label: 'Indemnification', severity: 'medium' },
      { flag: 'AUTO_RENEWAL_HIDDEN', label: 'Premium Auto-Renewal', severity: 'medium' },
    ],
    worstClause: "LinkedIn shares your professional data with recruiters, advertisers, and Microsoft affiliates.",
  ...
  },
  {
    ...
    score: 33,
    flags: [
      { flag: 'NON_REFUNDABLE', label: 'Non-Refundable Tickets', severity: 'high' },
      { flag: 'PRICE_NOT_GUARANTEED', label: 'Price Changes', severity: 'medium' },
      { flag: 'BROAD_INDEMNIFICATION', label: 'Liability Limits', severity: 'high' },
    ],
    worstClause: "United limits liability to $3,800 for lost baggage regardless of actual value. Many tickets are non-refundable.",
    tosUrl: 'https://www.united.com/ual/en/us/fly/contract-of-carriage.html',
  ...
  },
  {
    ...
    flags: [
      { flag: 'BINDING_ARBITRATION', label: 'Binding Arbitration', severity: 'high' },
      { flag: 'DATA_SHARING_EXTENSIVE', label: 'Data Monetization', severity: 'medium' },
      { flag: 'CLASS_ACTION_WAIVER', label: 'Class Action Waiver', severity: 'high' },
    ],
    worstClause: "X may use your posts for AI training and advertising. You grant X a worldwide, royalty-free license to your content.",
  ...
  },
  {
    ...
    flags: [
      { flag: 'PRICE_NOT_GUARANTEED', label: 'Price Changes', severity: 'medium' },
      { flag: 'FOREIGN_JURISDICTION', label: 'Netherlands Jurisdiction', severity: 'medium' },
      { flag: 'BROAD_INDEMNIFICATION', label: 'Indemnification', severity: 'medium' },
    ],
    worstClause: "Booking.com acts only as intermediary. All disputes must be resolved with the property directly or in Dutch courts.",
  ...
  },
  {
    ...
    flags: [
      { flag: 'BINDING_ARBITRATION', label: 'Binding Arbitration', severity: 'high' },
      { flag: 'CHARGEBACK_WAIVER', label: 'Dispute Limitations', severity: 'medium' },
      { flag: 'BROAD_INDEMNIFICATION', label: 'Holds & Freezes', severity: 'medium' },
    ],
    worstClause: "PayPal may hold funds for 180 days during disputes. You agree to binding arbitration for all claims.",
